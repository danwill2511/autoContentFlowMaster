    ...
    <footer className="bg-white mt-12">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
          ...
          <div className="px-5 py-2">
            <Link href="/help" className="text-base text-neutral-500 hover:text-neutral-900">
              Help Center
            </Link>
          </div>

          <div className="px-5 py-2">
            <Link href="/api-docs" className="text-base text-neutral-500 hover:text-neutral-900">
              API Docs
            </Link>
          </div>
        ...
        <p className="mt-8 text-center text-base text-neutral-400">&copy; 2025 AutoContentFlow. All rights reserved.</p>
      </div>
    </footer>
  );
}
