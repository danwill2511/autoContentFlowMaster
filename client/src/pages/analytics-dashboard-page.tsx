...
import { Loader2, BarChart2, PieChart as PieChartIcon, TrendingUp, Share2, ThumbsUp, MessageSquare } from "lucide-react";
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                      ...
                      dataKey="value"
                    >
                      {analyticsData.contentTypePerformance.map((entry, index) => (
